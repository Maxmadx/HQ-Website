...
export const TEXT_SECTIONS = [
...

  {
    ...
    fields: [
      { id: 'pre_label',   label: 'Pre-label',   type: 'text',      default: 'Self-Fly Hire' },
      { id: 'heading',     label: 'Heading',      type: 'heading',   default: 'Fly Yourself' },
      { id: 'description', label: 'Description',  type: 'paragraph', default: 'Access Europe\'s largest Robinson fleet. Fly where you want, when you want—with the freedom only helicopter travel provides.' },
    ],
  },
...

  {
    ...
    fields: [
      { id: 'pre_label',   label: 'Pre-label',          type: 'text',      default: 'New Aircraft' },
      { id: 'heading',     label: 'Section Heading',    type: 'heading',   default: 'Buy New' },
...

  {
    ...
    fields: [
      ...
      { id: 'speed',   label: 'Speed',      type: 'text',    default: '140 kts' },
    ],
  },

  {
    ...
    fields: [
      ...
      { id: 'speed',   label: 'Speed',      type: 'text',    default: '120 kts' },
    ],
  },

  {
    ...
    fields: [
      ...
      { id: 'speed',   label: 'Speed',      type: 'text',    default: '113 kts' },
    ],
  },

  {
    ...
    fields: [
      ...
      { id: 'speed',   label: 'Speed',      type: 'text',    default: '96 kts' },
    ],
  },
...

  {
    ...
    fields: [
      ...
      { id: 'seats',       label: 'Seats',          type: 'text',      default: '8' },
      { id: 'speed',       label: 'Max Speed',      type: 'text',      default: '140 kts' },
      { id: 'range',       label: 'Range',          type: 'text',      default: '400 nm' },
...

  {
    ...
    fields: [
      ...
      { id: 'seats',       label: 'Seats',          type: 'text',      default: '5' },
      { id: 'speed',       label: 'Max Speed',      type: 'text',      default: '120 kts' },
      { id: 'range',       label: 'Range',          type: 'text',      default: '350 nm' },
...

  {
    ...
    fields: [
      ...
      { id: 'seats',       label: 'Seats',          type: 'text',      default: '4' },
      { id: 'speed',       label: 'Max Speed',      type: 'text',      default: '113 kts' },
      { id: 'range',       label: 'Range',          type: 'text',      default: '300 nm' },
...

  {
    ...
    fields: [
      ...
      { id: 'seats',       label: 'Seats',          type: 'text',      default: '2' },
      { id: 'speed',       label: 'Max Speed',      type: 'text',      default: '96 kts' },
      { id: 'range',       label: 'Range',          type: 'text',      default: '200 nm' },
...

  {
    ...
    fields: [
      ...
      { id: 'heading',   label: 'Heading',   type: 'heading',   default: 'Become a Pilot' },
      { id: 'subtitle',  label: 'Subtitle',  type: 'paragraph', default: 'Train with world-class instructors at Denham Aerodrome, just 20 minutes from Central London.' },
    ],
  },

  {
    ...
    fields: [
      { id: 'heading',     label: 'Heading',     type: 'heading',   default: 'Why Train With Us?' },
      { id: 'description', label: 'Description', type: 'paragraph', default: 'HQ Aviation has been training helicopter pilots since 1994. Our team of experienced instructors, world-class fleet, and purpose-built facilities make us the UK\'s premier training school.' },
    ],
  },
...

  {
    ...
    page: 'about',
    name: 'Hero Section',
    hint: 'Main headline and subtitle on the About Us page',
    fields: [
      { id: 'pre_label', label: 'Pre-label', type: 'text',      default: 'ABOUT US' },
      { id: 'heading',   label: 'Heading',   type: 'heading',   default: 'HQ Aviation' },
      { id: 'subtitle',  label: 'Subtitle',  type: 'paragraph', default: 'The UK\'s premier Robinson helicopter company — training, hire, sales, and maintenance since 1994.' },
    ],
  },

  {
    ...
    fields: [
      { id: 'pre_label', label: 'Pre-label', type: 'text',      default: 'Our Founder' },
      { id: 'name',      label: 'Name',       type: 'heading',   default: 'Captain Quentin Smith' },
      { id: 'title',     label: 'Title',      type: 'text',      default: 'Founder & Managing Director' },
      { id: 'bio',       label: 'Biography',  type: 'paragraph', default: 'World Helicopter Champion and the first person to fly a helicopter to both the South and North Poles. Quentin founded HQ Aviation in 1994 with a simple mission: to share the extraordinary freedom of helicopter flight with as many people as possible.' },
    ],
  },
