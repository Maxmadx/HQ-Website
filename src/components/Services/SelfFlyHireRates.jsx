        ...
        <div className="hq-container" style={{ maxWidth: '800px' }}>
          ...
          <div style={{ background: 'var(--hq-background)', borderRadius: '12px', overflow: 'hidden' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '1rem', padding: '1.25rem 1.5rem', borderBottom: '1px solid var(--hq-border)', alignItems: 'center' }}>
              ...
              <div style={{ textAlign: 'center', fontWeight: 700, fontSize: '1.1rem' }}>{fmt('sfh_r22_wet')}/hr</div>
              <div style={{ textAlign: 'center', fontSize: '0.9rem', color: '#22c55e' }}>{fmt('sfh_r22_block')}/hr</div>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '1rem', padding: '1.25rem 1.5rem', borderBottom: '1px solid var(--hq-border)', alignItems: 'center' }}>
              <div><strong>Robinson R44 Raven II</strong><br /><span style={{ fontSize: '0.8rem', color: 'var(--hq-muted)' }}>4-seat piston</span></div>
              <div style={{ textAlign: 'center', fontWeight: 700, fontSize: '1.1rem' }}>{fmt('sfh_r44_wet')}/hr</div>
              <div style={{ textAlign: 'center', fontSize: '0.9rem', color: '#22c55e' }}>{fmt('sfh_r44_block')}/hr</div>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '1rem', padding: '1.25rem 1.5rem', alignItems: 'center' }}>
              ...
              <div style={{ textAlign: 'center', fontWeight: 700, fontSize: '1.1rem' }}>{fmt('sfh_r66_wet')}/hr</div>
              <div style={{ textAlign: 'center', fontSize: '0.9rem', color: '#22c55e' }}>{fmt('sfh_r66_block')}/hr</div>
            </div>
          </div>
