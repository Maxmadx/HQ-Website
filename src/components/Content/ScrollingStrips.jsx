...
const ScrollingStrips = ({ sticky = true, wrapperRef = null }) => {
  const containerRef = useRef(null);

  // Track the wrapper if provided (for sticky mode), otherwise track self
  ...
  return (
    <section
      ...
      ref={containerRef}
      style={sticky ? { position: 'sticky', top: '85px', zIndex: 50 } : {}}
    >
      <style>{`
        .scrolling-strips {
          background: #1a1a1a;
