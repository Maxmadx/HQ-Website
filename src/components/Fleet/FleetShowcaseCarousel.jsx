      ...
      <section style={{ padding: '4rem 0', background: 'var(--hq-hover-bg)' }}>
        ...
        <div style={{ display: 'flex', gap: '1.5rem', padding: '0 2rem', overflowX: 'auto' }}>
          <div style={{ flex: '0 0 300px', background: '#fff', borderRadius: 'var(--radius-lg)', padding: '2rem', textAlign: 'center' }}>
            <img src="/assets/images/new-aircraft/r22/r22-red-volcano-front-alpha-v3.png" alt="R22" width={1920} height={1080} style={{ height: '120px', marginBottom: '1rem' }} />
          ...
          <div style={{ flex: '0 0 300px', background: '#fff', borderRadius: 'var(--radius-lg)', padding: '2rem', textAlign: 'center' }}>
            <img src="/assets/images/new-aircraft/r44/raven-ii-front-alpha.png" alt="R44" width={1920} height={1080} style={{ height: '120px', marginBottom: '1rem' }} />
          ...
          <div style={{ flex: '0 0 300px', background: 'var(--hq-primary)', borderRadius: 'var(--radius-lg)', padding: '2rem', textAlign: 'center', color: '#fff', position: 'relative' }}>
            ...
            <img src="/assets/images/new-aircraft/r66/blue-r66-palo-verde-front-v4.png" alt="R66" width={2500} height={1406} style={{ height: '120px', marginBottom: '1rem', marginTop: '1rem' }} />
          ...
          <div style={{ flex: '0 0 300px', background: '#fff', borderRadius: 'var(--radius-lg)', padding: '2rem', textAlign: 'center' }}>
            <img src="/assets/images/new-aircraft/r88/r88-jellybean-left.png" alt="R88" width={2500} height={1406} style={{ height: '120px', marginBottom: '1rem' }} />
