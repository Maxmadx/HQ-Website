        ...
        <div className="hq-container" style={{ maxWidth: '800px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div style={{ background: '#fff', padding: '1.5rem', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <span style={{ fontWeight: 700, color: 'var(--hq-accent)', fontSize: '1.1rem', whiteSpace: 'nowrap' }}>{fmt('costs_training_from')} - {fmt('costs_training_to')}</span>
            </div>
            <div style={{ background: '#fff', padding: '1.5rem', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ background: '#fff', padding: '1.5rem', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <span style={{ fontWeight: 700, color: 'var(--hq-accent)', fontSize: '1.1rem' }}>{fmt('costs_exams_from')} - {fmt('costs_exams_to')}</span>
            </div>
            <div style={{ background: '#fff', padding: '1.5rem', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <span style={{ fontWeight: 700, color: 'var(--hq-accent)', fontSize: '1.1rem' }}>{fmt('costs_medical_from')} - {fmt('costs_medical_to')}</span>
            </div>
            <div style={{ background: 'var(--hq-primary)', color: '#fff', padding: '1.5rem', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '1rem' }}>
              ...
              <strong style={{ fontSize: '1.75rem' }}>{fmt('costs_total_from')} - {fmt('costs_total_to')}</strong>
            </div>
          </div>
