        ...
        <div className="hq-container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem', maxWidth: '900px', margin: '0 auto' }}>
            <div style={{ background: '#fff', borderRadius: '12px', padding: '2rem', textAlign: 'center', borderTop: '4px solid var(--hq-accent)' }}>
              ...
              <div style={{ fontSize: '0.8rem', color: 'var(--hq-muted)' }}>From <strong style={{ fontSize: '1.25rem', color: 'var(--hq-primary)' }}>{fmt('type_rating_r22')}</strong></div>
            </div>
            <div style={{ background: '#fff', borderRadius: '12px', padding: '2rem', textAlign: 'center', borderTop: '4px solid var(--hq-primary)' }}>
              ...
              <div style={{ fontSize: '0.8rem', color: 'var(--hq-muted)' }}>From <strong style={{ fontSize: '1.25rem', color: 'var(--hq-primary)' }}>{fmt('type_rating_r44')}</strong></div>
            </div>
            <div style={{ background: '#fff', borderRadius: '12px', padding: '2rem', textAlign: 'center', borderTop: '4px solid #6366f1' }}>
              ...
              <div style={{ fontSize: '0.8rem', color: 'var(--hq-muted)' }}>From <strong style={{ fontSize: '1.25rem', color: 'var(--hq-primary)' }}>{fmt('type_rating_r66')}</strong></div>
            </div>
          </div>
        </div>
      </section>
