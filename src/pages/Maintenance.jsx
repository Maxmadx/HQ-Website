...
function Maintenance() {
  ...
  const helicopterModels = [
    { model: 'Robinson R22',    description: 'Full maintenance support for all R22 variants',            image: '/assets/images/new-aircraft/r22-beta.webp' },
    { model: 'Robinson R44',    description: 'Authorized service for Raven, Cadet, and Clipper models',  image: '/assets/images/new-aircraft/r44-raven.webp' },
    { model: 'Robinson R66',    description: 'Turbine expertise for the R66 range',                      image: '/assets/images/new-aircraft/r66-turbine.webp' },
    { model: 'Guimbal Cabri G2',description: 'Certified Cabri G2 service centre',                       image: '/assets/images/new-aircraft/cabri-g2.webp' },
  ].map((m, i) => ({ ...m, image: pageImages['maintenance-aircraft']?.[i]?.url ?? m.image }));
      ...
      <section className="section">
        <div className="container">
          <div className="grid grid--2 gap-8 items-center">
            ...
            <div>
              <img
                src={pageImages['maintenance-facility']?.[0]?.url ?? '/assets/images/facility/hq-aviation-helicopter-hangar.webp'}
      ...
      <section className="section section--alt">
        <div className="container">
          <div className="grid grid--2 gap-8 items-center">
            <div>
              <img
                src={pageImages['maintenance-overhaul']?.[0]?.url ?? '/assets/images/facility/g-ccfc-hq-robinson-overhaul.webp'}
