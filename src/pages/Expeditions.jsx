...
function Expeditions() {
  ...
  const expeditions = [
    { title: 'Scottish Highlands', description: 'Explore the dramatic landscapes of Scotland from above. Soar over lochs, glens, and ancient castles on this unforgettable adventure.', duration: '5 Days', flyingHours: '12 Hours', price: 'From £8,500', link: '/expeditions/scottish-highlands', image: '/assets/images/expeditions/scottish-highlands.webp' },
    { title: 'Norwegian Fjords',   description: 'Navigate the stunning fjords of Norway. Experience breathtaking waterfalls, snow-capped peaks, and remote villages.', duration: '7 Days', flyingHours: '18 Hours', price: 'From £12,500', link: '/expeditions/norwegian-fjords', image: '/assets/images/expeditions/norwegian-fjords.webp' },
    { title: 'Moroccan Atlas',     description: 'Discover the beauty of Morocco from the air. Fly over the Atlas Mountains, Sahara Desert, and ancient medinas.', duration: '6 Days', flyingHours: '15 Hours', price: 'From £14,000', link: '/expeditions/moroccan-atlas', image: '/assets/images/expeditions/moroccan-atlas.webp' },
    { title: 'Swiss Alps',         description: 'Experience the majesty of the Swiss Alps. Land at exclusive mountain locations and enjoy world-class hospitality.', duration: '4 Days', flyingHours: '10 Hours', price: 'From £9,500', link: '/expeditions/swiss-alps', image: '/assets/images/expeditions/swiss-alps.webp' },
  ].map((exp, i) => ({ ...exp, image: pageImages['expeditions-cards']?.[i]?.url ?? exp.image }));
      ...
      <section className="section">
        <div className="container">
          <div className="grid grid--2 gap-8 items-center">
            ...
            <div>
              <img
                src={pageImages['expeditions-bespoke']?.[0]?.url ?? '/assets/images/expeditions/bespoke-adventure.webp'}
      ...
      <section className="section section--alt">
        <div className="container">
          <div className="grid grid--2 gap-8 items-center">
            <div>
              <img
                src={pageImages['expeditions-captain']?.[0]?.url ?? '/assets/images/expeditions/helicopter-expeditions-quentin-smith.webp'}
