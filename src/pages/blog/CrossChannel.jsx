...
function CrossChannel() {
  return (
    <BlogLayout
      postId="cross-channel"
      title="Crossing the Channel: Your Guide to Flying to France"
      category="Operations"
      date="2025-11-14"
      heroImage="/assets/images/expeditions/channel.jpg"
    >
      <p>
        There's a moment, roughly halfway across the English Channel, when England has
      ...
      <p>
        ...
        from one aviation system to another. It is, without question, one of the most
        popular cross-border general aviation flights in the world, and for good reason.
      </p>
      ...
      <p>
        ...
        involves more paperwork and preparation than a domestic sortie, none of it is
        especially difficult. It simply requires thoroughness.
      </p>

      <p>
        This guide walks you through everything you need to know: the documents, the
        forms, the equipment, the routing, the radio calls, and the practical tips that
        will turn your first channel crossing from a daunting prospect into an
        unforgettable adventure.
      </p>

      <h2>Documents and Licences</h2>

      <p>
        Before you even begin flight planning, you need to ensure your personal
        documentation is in order. International GA flights have specific requirements
        that go beyond what you'd need for a domestic flight, and getting any of these
        wrong will stop your trip before it starts.
      </p>

      <h3>Pilot Licence</h3>

      <p>
        You must hold a <strong>UK Part-FCL Private Pilot's Licence (PPL)</strong> as a
        minimum. This is the critical point that catches some pilots out: a LAPL (Light
        Aircraft Pilot Licence) is <strong>not valid</strong> for international flights.
        The LAPL is restricted to UK-registered aircraft operating within UK airspace.
        If you hold a LAPL and want to cross the channel, you'll need to upgrade to a
        full PPL first.
      </p>
      ...
      <p>
        You will also need a valid <strong>Flight Radiotelephony Operator's Licence
        (FRTOL)</strong>. This is normally obtained during PPL training and is required
        for all flights using radio communications. For a channel crossing, you'll be
        talking to multiple agencies on both sides of the water, so your FRTOL is
        essential.
      </p>
      ...
      <p>
        The GAR must be submitted <strong>at least 2 hours before departure</strong> for
        outbound flights. You'll need to complete a separate GAR for your return journey
        as well. The form captures details including aircraft registration, pilot information,
        passenger details, departure and destination aerodromes, and estimated times.
      </p>
      ...
      <h2>Customs Aerodromes</h2>

      <p>
        Here's a detail that catches out many pilots planning their first international
        flight: you <strong>must depart from and return to a customs-approved
        aerodrome</strong>. Not every airfield in the UK has customs facilities, and
        departing from a non-customs aerodrome on an international flight is illegal.
      </p>

      <p>
        For channel crossings, the most commonly used customs aerodromes in the south-east
        include:
      </p>
      ...
      <Callout variant="warning" title="Denham Is Not a Customs Aerodrome">
        Denham Aerodrome (EGLD), our home base at HQ Aviation, does not have customs
        facilities. You cannot depart directly from Denham on an international flight.
        Instead, plan to route via a customs aerodrome such as Lydd or Biggin Hill. Many
        of our pilots fly from Denham to Lydd first, clear customs, and then continue
        across the channel.
      </Callout>

      <h2>Life Jackets and Safety Equipment</h2>

      <p>
        For the overwater portion of a channel crossing, life jackets are
      ...
      <p>
        ...
        dramatically increases the speed of rescue response.
      </p>

      <p>
        If you're flying a helicopter, consider the additional complexities of a
        potential ditching versus a fixed-wing aircraft. Helicopters have specific
        ditching characteristics that are worth understanding before any overwater
        flight. A brief refresher on emergency procedures is time well spent.
      </p>

      <h2>Filing a Flight Plan</h2>
      ...
      <p>
        The most convenient way to file a flight plan is through <strong>SkyDemon</strong>,
        which most UK GA pilots already use for navigation. SkyDemon allows you to plan
        your route and file the flight plan directly from the application. Alternatively,
        you can file via <strong>AFPEx</strong> (Aeronautical Flight Plan Exchange), the
        official flight plan filing system, which is accessible online.
      </p>
      ...
      <p>
        ...
        options narrow uncomfortably.
      </p>

      <h3>The Crossing Itself</h3>
      ...
      <p>
        Radio coverage can be patchy mid-channel. You may find yourself in a gap between
        UK and French coverage, particularly at lower altitudes. Before the crossing,
        you'll typically be with <strong>London Information</strong> (124.750 MHz) or
        a radar service if available. As you approach the French coast, you'll need
        to contact <strong>Lille Information on 120.275 MHz</strong> for a French
        information service.
      </p>

      <Callout variant="info" title="Mid-Channel Radio">
        Be prepared for a brief period of reduced radio coverage mid-channel. Maintain
        your last assigned squawk code and continue on your planned track. If you lose
        contact entirely, continue the crossing and re-establish communications as you
        approach the French coast. Monitor 121.500 MHz (emergency frequency) if you have
        a second radio. The gap is typically brief and nothing to worry about, but it's
        worth being mentally prepared for it.
      </Callout>
      ...
      <p>
        ...
        destination than pressing on into poor visibility over water.
      </p>

      <h2>French Destinations</h2>

      <p>
        The French coast offers several excellent aerodromes for visiting British pilots.
        Each has its own character and appeal, and all are well accustomed to receiving
        cross-channel GA traffic.
      </p>

      <h3>Le Touquet (LFAT)</h3>
      ...
      <p>
        The approach to Le Touquet is straightforward, with the aerodrome situated just
      ...
      <h3>Calais-Dunkerque (LFAC)</h3>

      <p>
        <strong>Calais-Dunkerque</strong> is the closest French aerodrome to the UK
        coast, making it an appealing option for pilots wanting to minimise their
        overwater time. The field is well-equipped and less busy than Le Touquet,
        which can be an advantage on popular flying days when Le Touquet's circuit
        gets congested with visiting British aircraft.
      </p>

      <h3>Abbeville (LFOI)</h3>

      <p>
        For pilots with a taste for aviation history, <strong>Abbeville</strong> is
        a wonderful destination. The aerodrome is home to a warbird museum with an
        impressive collection of historic aircraft. It's slightly further south than
        Le Touquet, requiring a longer overland transit on the French side, but the
        museum alone makes it worth the trip. The aerodrome itself has a relaxed,
        welcoming atmosphere that's typical of smaller French GA fields.
      </p>

      <h2>Customs and Border Procedures</h2>

      <h3>Arriving in France</h3>

      <p>
        French customs procedures for visiting GA aircraft are generally straightforward
      ...
      <p>
        On arrival back in the UK, you must land at a <strong>customs-approved
        aerodrome</strong>. If you departed from Lydd, it makes sense to return there.
        Report to customs on arrival, present your documentation, and you'll be cleared
        to continue to your home base. From Lydd, it's a pleasant flight back to Denham
        or wherever your journey began.
      </p>

      <h2>Fuel Planning</h2>

      <p>
        Fuel planning for a channel crossing deserves careful attention, though for most
        of our aircraft the range is more than adequate. The key is to calculate your
        fuel requirements for the <strong>entire round trip</strong>, not just the outbound
        leg, and to factor in reserves.
      </p>

      <p>
        The <strong>Robinson R44 Raven II</strong>, for instance, has an endurance of
        approximately <strong>3.5 hours</strong> with standard tanks. Given that the
        channel crossing itself takes roughly 15 minutes, and the total flight time from
        Denham to Le Touquet via Lydd is typically under two hours, you have ample fuel
        range. However, you should always plan to refuel if necessary rather than relying
        on single-tank range for the round trip.
      </p>

      <p>
        The <strong>Robinson R66</strong> offers a particular advantage for French trips:
        it runs on <strong>Jet A1 fuel</strong>, which is widely available at French
        aerodromes. Avgas (100LL), used by piston aircraft including the R44, is available
        at the major fields like Le Touquet but can be harder to find at smaller French
        strips. If you're flying an avgas aircraft and planning to visit a less common
        destination, confirm fuel availability in advance.
      </p>
      ...
      <Callout variant="warning" title="Channel Weather Changes Fast">
        The channel's weather can shift dramatically within an hour. What looks like a
        clear crossing window can close rapidly as sea fog rolls in or a front arrives
        earlier than forecast. Always have a "no-go" decision point before you leave the
        coast, and don't be afraid to use it. A night in Le Touquet because the weather
        closed in is an inconvenience. Pressing on into deteriorating conditions over
        open water is genuinely dangerous.
      </Callout>

      <h2>Practical Tips for Your First Crossing</h2>

      <h3>Use SkyDemon</h3>

      <p>
        <strong>SkyDemon</strong> is invaluable for channel crossings. It handles flight
        plan filing, shows your track over the water in real time, displays weather
        information, and provides moving-map navigation that takes the stress out of
        the overwater portion. If you don't already use SkyDemon, invest in a subscription
        before your first international flight. It will pay for itself many times over in
        reduced workload and increased confidence.
      </p>

      <h3>Check NOTAMs Thoroughly</h3>

      <p>
        French NOTAMs can catch out pilots who are accustomed to the UK system. Airspace
        restrictions, aerodrome closures, and military activity may all affect your
        planned route. Check NOTAMs for your destination aerodrome, your alternate, and
        the en-route airspace on both sides of the channel. Pay particular attention to
        French military zones, which can be active at times that might surprise you.
      </p>

      <h3>Consider an Instructor Checkout</h3>
      ...
      <p>
        Plan your departure to arrive in France with plenty of time to enjoy your
        destination and still return in good conditions. An early-morning departure from
        Denham, customs clearance at Lydd, and a crossing that puts you in Le Touquet
        by mid-morning is ideal. This gives you a relaxed lunch, time for a stroll along
        the beach, and a comfortable afternoon return with daylight and weather margins
        to spare.
      </p>
      ...
      <p>
        At HQ Aviation, we've seen the expression on pilots' faces when they shut down
        in Le Touquet for the first time. It's a mixture of pride, excitement, and
        slight disbelief that they've actually done it. And almost without exception,
        the first thing they say is: "When can we do this again?"
      </p>
      ...
      <p>
        If you're thinking about your first crossing, talk to us. We'll help you prepare,
        fly with you if you'd like company, and make sure your first international flight
        is everything it should be. The channel has been crossed by aviators for over a
        century. It's time to add your name to the list.
      </p>
