...
const PAGES = [
  {
    ...
    groups: [
      ...
      {
        label: 'Expeditions',
        desc: 'Destination thumbnails and expanded gallery photos for each destination',
        sections: [
          'home-exped-barcode-thumbs',
          'home-exped-gallery-arctic',
          'home-exped-gallery-iceland',
          'home-exped-gallery-morocco',
          'home-exped-gallery-norway',
          'home-exped-gallery-alps',
          'home-exped-gallery-greenland',
          'home-exped-gallery-bahamas',
          'home-exped-gallery-costa-rica',
        ],
      },
      {
        label: 'Contact',
    ...
    where: {
      ...
      'home-facility-gallery':      'Maintenance · Lightbox photo gallery',
      'home-exped-barcode-thumbs':       'Expeditions section · Thumbnail per destination card (8 cards)',
      'home-exped-gallery-arctic':       'Expeditions section · Arctic expanded gallery',
      'home-exped-gallery-iceland':      'Expeditions section · Iceland expanded gallery',
      'home-exped-gallery-morocco':      'Expeditions section · Morocco expanded gallery',
      'home-exped-gallery-norway':       'Expeditions section · Norway expanded gallery',
      'home-exped-gallery-alps':         'Expeditions section · Alps expanded gallery',
      'home-exped-gallery-greenland':    'Expeditions section · Greenland expanded gallery',
      'home-exped-gallery-bahamas':      'Expeditions section · Bahamas expanded gallery',
      'home-exped-gallery-costa-rica':   'Expeditions section · Costa Rica expanded gallery',
  ...
  },
  {
    ...
    groups: [
      ...
      { label: 'Used Aircraft', desc: 'Photos for used aircraft listings', sections: ['sales-used'] },
      { label: 'Paint Schemes', desc: 'One image per paint scheme option', sections: ['sales-paint'] },
    ],
    where: {
      ...
      'sales-used':            'Used Aircraft section · One photo per listing',
      'sales-paint':           'Paint Gallery · One image per paint scheme',
    },
  },
  {
    id: 'training',
  ...
  },
  {
    ...
    url: '/expeditions',
    groups: [
      { label: 'Destinations', desc: 'Destination cards and bespoke adventures section', sections: ['expeditions-cards', 'expeditions-bespoke'] },
      { label: 'Your Guide', desc: 'Captain Q expedition portrait', sections: ['expeditions-captain'] },
    ],
    where: {
      'expeditions-cards':   'Destination cards · One image per destination (Scottish Highlands, etc.)',
      'expeditions-bespoke': 'Bespoke Adventures section · Photo beside the text',
      'expeditions-captain': '"Your Guide" section · Captain Q expedition portrait',
    },
  },
  {
    id: 'about',
    ...
    url: '/about-us',
    groups: [
      { label: 'Captain Q', desc: 'Founder portrait photo', sections: ['about-founder'] },
    ],
    where: {
