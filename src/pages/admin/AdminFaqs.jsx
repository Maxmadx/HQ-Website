...
const PAGES = [
  { key: 'discovery',    label: 'Discovery Flight' },
  { key: 'sfh',          label: 'Self-Fly Hire' },
  { key: 'sales',        label: 'Sales' },
  { key: 'expeditions',  label: 'Expeditions' },
  { key: 'ppl',          label: 'PPL Training' },
  { key: 'night-rating', label: 'Night Rating' },
  { key: 'type-rating',  label: 'Type Rating' },
  { key: 'training-faq', label: 'Training FAQ' },
];
